#==================================================================
#  
#  SCOOTER: normalization manual case
#  Mexilhoeira Grande, Sab Jul 29 10:30:12 WEST 2017
#  Written by Tordar
#  
#==================================================================
...
print("SCOOTER - normalization manual case")
...
xlabel('Range (km)')
ylabel('TL (dB)')
title('SCOOTER - normalization manual case')
ylim(tlmax,tlmin)
grid(True)
