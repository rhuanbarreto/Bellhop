...
disp('KRAKEN - Leaky surface duct') 

system('kraken.exe sductK');
system('fields.exe sductK < sductK.flp');

[ PlotTitle, PlotType, freq, atten, Pos, p ] = read_shd( 'sductK.shd' );
...
xlabel('Range (km)')
ylabel('Depth (m)')
title('KRAKEN - Leaky surface duct, 200 Hz')

plotmode( 'sductK.mod', [1:5] );
