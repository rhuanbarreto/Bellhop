...
system('bellhop3d.exe slice3dHatRaycenSemi');

[ PlotTitle, PlotType, freq, atten, Pos, p ] = read_shd( 'slice3dHatRaycenSemi.shd' );
...
pcolor(rarraykm,zarray,tl1), shading interp, colormap( tej ), caxis([40 100]), 
h = colorbar;
set( h, 'YDir', 'reverse' );
hold off
xlabel('Range (km)')
