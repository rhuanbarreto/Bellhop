...
system('bellhop3d.exe slice3dHatCartSemi');

[ PlotTitle, PlotType, freq, atten, Pos, p ] = read_shd( 'slice3dHatCartSemi.shd' );
...
pcolor(rarraykm,zarray,tl1), shading interp, colormap( tej ), caxis([50 100]), 
h = colorbar;
set( h, 'YDir', 'reverse' );
hold off
xlabel('Range (km)')
