...
disp('TL calculation, Hat Cart. Coord')

system('bellhop3d.exe freeBhatpolar');

[ PlotTitle, PlotType, freq, atten, Pos, p ] = read_shd( 'freeBhatpolar.shd' );
