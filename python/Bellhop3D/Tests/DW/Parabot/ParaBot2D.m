...
system('cp ParaBot.ati ParaBot2D.ati');
system('cp ParaBot.bty ParaBot2D.bty');
system('bellhop3d.exe ParaBot2D');
system('rm ParaBot2D.ati');
system('rm ParaBot2D.bty');

[ PlotTitle, PlotType, freq, atten, Pos, p ] = read_shd( 'ParaBot2D.shd' );
