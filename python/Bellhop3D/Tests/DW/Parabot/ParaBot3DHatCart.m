...
system('cp ParaBot.ati ParaBot3DHatCart.ati');
system('cp ParaBot.bty ParaBot3DHatCart.bty');
system('bellhop3d.exe ParaBot3DHatCart');
system('rm ParaBot3DHatCart.ati');
system('rm ParaBot3DHatCart.bty');

[ PlotTitle, PlotType, freq, atten, Pos, p ] = read_shd( 'ParaBot3DHatCart.shd' );
