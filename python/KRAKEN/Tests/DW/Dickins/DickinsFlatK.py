...
print("KRAKEN - Dickins seamount")

system("kraken.exe DickinsFlatK")
system("fields.exe DickinsFlatK < DickinsFlatK.flp")

filename = 'DickinsFlatK.shd'
xs = nan
ys = nan
...
xlabel('Range (km)')
ylabel('Depth (m)')
title('KRAKEN - Dickins waveguide')
ylim(Dmax,0)
