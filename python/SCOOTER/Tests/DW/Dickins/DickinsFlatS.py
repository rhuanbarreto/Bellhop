#==================================================================
#  
#  SCOOTER: Dickins seamount
#  Mexilhoeira Grande, Sab Jul 29 12:48:54 WEST 2017
#  Written by Tordar
#  
#==================================================================

# ipython: run DickinsFlatS
...
print("SCOOTER - Dickins seamount")

system("scooter.exe DickinsFlatS")
system("fields.exe DickinsFlatS < DickinsFlatS.flp")

filename = 'DickinsFlatS.shd'
xs = nan
ys = nan
...
xlabel('Range (km)')
ylabel('Depth (m)')
title('SCOOTER - Dickins waveguide')
ylim(Dmax,0)
