...
system('bellhop3d.exe wedge3dHatRayCen');

[ PlotTitle, PlotType, freq, atten, Pos, p ] = read_shd( 'wedge3dHatRayCen.shd' );
...
xlabel('X (km)')
ylabel('Y (km)')
title('Bellhop3D - TWedge profile')
